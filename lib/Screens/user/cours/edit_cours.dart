...
class EditCours extends StatefulWidget {
  final Cours cours;
  const EditCours({Key? key, required this.cours}) : super(key: key);

  @override
  State<EditCours> createState() => _EditCoursState();
}
...
class _EditCoursState extends State<EditCours> {
  ...
  getCurrentData() async {
    setState(() {
      ...
      subjectController.text = widget.cours.description;
      selectedCategory = categories.firstWhere((element) => element.id == widget.cours.categoryId);
    });
  }
            ...
            children: [
              ...
              Container(
                  ...
                  child: ElevatedButton.icon(
                      ...
                      label: Text(_filePath == null ? "Modifier le fichier pdf" : _filePath!.split("/").last))),
              Padding(
                        ...
                        : () async {
                            if (_formKey.currentState!.validate() && selectedCategory != null) {
                              ...
                              if (_filePath != null) {
                                ...
                                FirebaseFirestore.instance.collection("cours").doc(widget.cours.id).update({
                                  "file": imageUrl,
